...
import { FiMessageCircle, FiSend, FiDownload, FiTrendingUp } from 'react-icons/fi';
...
const UserChatbot = () => {
  ...
  const suggestedQueries = [
    'Show mining volume for my lease area this month',
    'Detect anomalies in my mining site using latest satellite images',
    'Generate a PDF report for my mining activity',
    'What is my current mining efficiency?',
    'Compare my current mining area vs registered lease',
  ];
    ...
    try {
      ...
      if (useKB) {
        const res = await fetch(`${API_BASE_URL}/ai/chat/rag`, {
          ...
          body: JSON.stringify({ question: inputValue, persona: 'user', limit: 5, language: locale }),
        });
        if (!res.ok) {
          let detail = '';
      ...
      <main className="flex-1 container mx-auto px-4 py-12">
        ...
        >
          ...
          <p className="text-muted-foreground">
            Get insights, generate reports, and analyze your mining operations
          </p>
        </motion.div>
            ...
            <Card className="p-6 h-[700px] flex flex-col">
              ...
              <div className="flex gap-2">
                <Input
                  ...
                  placeholder="Ask about your mining activities, reports, or analytics..."
                  className="flex-1"
                />
